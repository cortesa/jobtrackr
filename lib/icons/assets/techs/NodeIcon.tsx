...
export function NodeIcon({ size = 24, ...props }: IconProps) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="node-gradient-a" x1="68.188%" y1="17.487%" x2="27.823%" y2="89.755%">
        ...
        <linearGradient id="node-gradient-c" x1="43.277%" y1="55.169%" x2="159.245%" y2="-18.306%">
        ...
        <linearGradient id="node-gradient-e" x1="-4.389%" y1="49.997%" x2="101.499%" y2="49.997%">
      ...
      <path
        ...
        d="M134.923 1.832c-4.344-2.443-9.502-2.443-13.846 0L6.787 67.801C2.443 70.244 0 74.859 0 79.745v132.208c0 4.887 2.715 9.502 6.787 11.945l114.29 65.968c4.344 2.444 9.502 2.444 13.846 0l114.29-65.968c4.344-2.443 6.787-7.058 6.787-11.945V79.745c0-4.886-2.715-9.501-6.787-11.944Z"
      />
      <mask id="node-mask-d" fill="#fff">
        <use xlinkHref="#node-path" />
      </mask>
      <path
        ...
        mask="url(#node-mask-d)"
      />
      <mask id="node-mask-f" fill="#fff">
        <use xlinkHref="#node-path" />
      </mask>
      <path
        fill="url(#node-gradient-e)"
