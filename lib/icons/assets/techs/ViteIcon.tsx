...
const VIEW_BOX = "0 0 410 404"

export function ViteIcon({ size = 24, ...props }: IconProps) {
  ...
  return (
    ...
    >
      <path
        ...
        d="m399.641 59.525-183.998 329.02c-3.799 6.793-13.559 6.833-17.415.073L10.582 59.556C6.38 52.19 12.68 43.266 21.028 44.76l184.195 32.923c1.175.21 2.378.208 3.553-.006l180.343-32.87c8.32-1.517 14.649 7.337 10.522 14.719"
      />
      <path
      ...
      />
      <defs>
        <linearGradient id="vite-gradient-a" x1={6} y1={33} x2={235} y2={344} gradientUnits="userSpaceOnUse">
          <stop stopColor="#41D1FF" />
          <stop offset={1} stopColor="#BD34FE" />
        </linearGradient>
        <linearGradient id="vite-gradient-b" x1={194.651} y1={8.818} x2={236.076} y2={292.989} gradientUnits="userSpaceOnUse">
